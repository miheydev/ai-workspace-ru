...
- **Context/Company/about.md** — подробная анкета о тебе
...
### Шаг 3. Заполнение Company/about.md
...
Прочитай текущий файл `CLAUDE.md`, затем обнови секцию **«Кто мы»**: название компании, чем занимается, площадки.

Остальные секции CLAUDE.md — правила работы, границы по данным, структуру — не трогай, они уже настроены.

Скажи пользователю, что это быстрая настройка на одного человека. Полный контекст компании — восемь разделов в `Context/Company/` — заполняется скиллом `/enrich-company` и дальше руками, каждый про своё направление.

### Шаг 5. Подтверждение

После заполнения обоих файлов скажи:
"Готово! Я заполнил:
- ✓ Context/Company/about.md — анкета о тебе и бизнесе
